...
namespace rewiind
{
    namespace wav
    {
        class RIFFHeader : common::ByteBuffer, common::GenericHeader
        {
        public:
        ...
        class WAVHeader : common::ByteBuffer, common::GenericHeader
        {
        public:
        ...
        class WAVDataHdr : common::ByteBuffer, common::GenericHeader
        {
        public:
